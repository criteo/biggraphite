...
class TestGraphiteUtils(bg_test_utils.TestCaseWithFakeAccessor):
    ...
    def test_glob(self):
        ...
        self.assertEqual((["a"], ["a", "x"]), bg_gu.glob_metrics_directories(self.accessor, "*"))
        self.assertEqual((["a.b.c", "x.y.c"], []), bg_gu.glob_metrics_directories(self.accessor, "*.*.c"))
        self.assertEqual((["a.a.a", "a.b.c", "a.b.d"], []), bg_gu.glob_metrics_directories(self.accessor, "a.*.*"))
        self.assertEqual((["a.a.a", "a.b.c", "a.b.d", "x.y.c"], []), bg_gu.glob_metrics_directories(self.accessor, "*.*.*"))
        self.assertEqual((["a.b.c", "a.b.d"], []), bg_gu.glob_metrics_directories(self.accessor, "*.{b,c,d,5}.?"))
