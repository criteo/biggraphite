...
class TestCommandCopy(bg_test_utils.TestCaseWithFakeAccessor):
    ...
    def test_copy_metric(self):
        ...
        for i in range(3):
            ...
            self.assertEqual([p for p in pts], [])
        ...
        for i in range(3):
            ...
            self.assertEqual([p for p in pts], [p for p in pts_copy])
    ...
    def test_get_metric_tuples(self):
        ...
        self.assertEqual(len(list_metrics(self.accessor, "*.**")), 2)
        metric_tuples = cmd_copy._get_metric_tuples(
            accessor=self.accessor,
            src="test", dst="copy",
        ...
        self.assertEqual(len(list_metrics(self.accessor, "*.**")), 4)
