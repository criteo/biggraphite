...
class TestGraphiteUtilsInternals(unittest.TestCase):
    ...
    def test_basename(self):
        self.assertEqual('a', gu._basename('a'))
        self.assertEqual('b', gu._basename('a.b'))
        self.assertEqual('c', gu._basename('a.b.c'))

    def test_dirname(self):
        self.assertEqual('', gu._dirname('a'))
        self.assertEqual('a.', gu._dirname('a.b'))
        self.assertEqual('a.', gu._dirname('a.*'))
        self.assertEqual('a.', gu._dirname('a.?'))
        self.assertEqual('a.', gu._dirname('a.b{c,d}'))
