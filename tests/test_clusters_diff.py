...
class TestRequest(unittest.TestCase):
    ...
    def test_parse_request_result(self):
        ...
        self.assertEquals(request._parse_request_result(raw_data)[0].__dict__,
                          diffable_target_1.__dict__)
        self.assertEquals(request._parse_request_result(raw_data)[1].__dict__,
                          diffable_target_2.__dict__)
