...
class Accessor(object):
    ...
    def fetch_points(self, metric_name, time_start, time_end, step,
        ...
        return _PointFetcher(time_start_ms, time_end_ms, step_ms,
                             aggregator_func, query_results)
...
class _PointFetcher(object):
    ...
    def __init__(self, time_start_ms, time_end_ms, step_ms,
                 aggregator_func, query_results):
    ...
    def run_aggregation(self):
        ...
        if self.current_timestamp_ms is None:
            return ret
        aggregate = self.aggregator_func(
