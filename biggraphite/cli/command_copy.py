...
class CommandCopy(command.BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--log-level",
            default="INFO",
            help="Override log levels.",
            required=False,
        )
        parser.add_argument(
            "--max-metrics-per-pattern",
            metavar="MAX", type=int,
            help="Override accessor max_metrics_per_pattern attribute.",
            required=False,
        )
    ...
    def run(self, accessor, opts):
        ...
        if accessor.max_metrics_per_pattern and opts.max_metrics_per_pattern:
            accessor.max_metrics_per_pattern = opts.max_metrics_per_pattern
