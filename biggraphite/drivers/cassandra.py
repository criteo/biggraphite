...
OPTIONS = {
    ...
    "meta_write_consistency": str,
    "meta_serial_consistency": str,
    "meta_read_consistency": str,
    "meta_background_consistency": str,
    "data_write_consistency": str,
    "data_read_consistency": str,
}
...
CONSISTENCIES = {
    ...
    "LOCAL_SERIAL": cassandra.ConsistencyLevel.LOCAL_SERIAL,
    "LOCAL_ONE": cassandra.ConsistencyLevel.LOCAL_ONE,
    }
...
class _LazyPreparedStatements(object):
    ...
    def __init__(self,
        ...
        self.__data_files = {}
        self._shard = shard
        self._data_write_consistency = CONSISTENCIES[data_write_consistency]
        self._data_read_consistency = CONSISTENCIES[data_read_consistency]
...
class _CassandraAccessor(bg_accessor.Accessor):
    ...
    def __init__(self,
        ...
        self._meta_write_consistency = CONSISTENCIES[meta_write_consistency]
        self._meta_read_consistency = CONSISTENCIES[meta_read_consistency]
        self._meta_serial_consistency = CONSISTENCIES[meta_serial_consistency]
        self._meta_background_consistency = CONSISTENCIES[meta_background_consistency]
        self._data_write_consistency = CONSISTENCIES[data_write_consistency]
        self._data_read_consistency = CONSISTENCIES[data_read_consistency]
        if writer is None:
