...
All rows in data table describe have the metric UUID and starting timestamp as part of their primary key, use the timestamp offset as the column key for each value.
