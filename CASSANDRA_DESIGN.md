...
### Expiry of data
TTLs take space and are only applied on compaction.
To make tweaking compaction earlier, we create one table per "stage" of retention policies. That way a given retention policy corresponds to a set of compaction tweaks.
